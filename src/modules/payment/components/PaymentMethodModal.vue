            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow-lg border-0 rounded-3">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="payment-methods">
                            ...
                            <div class="payment-method-option mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="paymentMethod" id="bankPayment"
                                        value="bank" v-model="paymentMethod" />
                            ...
                            <div class="payment-method-option">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="paymentMethod" id="driverPayment"
                                        value="driver" v-model="paymentMethod" />
                    ...
                    <div class="modal-footer bg-light">
                        <PrimaryButton :text="$t('common.cancel')" @click="closeModal"
                            bg-color="var(--color-secondary)" />
                        <PrimaryButton :text="$t('common.done')" bgColor="var(--color-success)" :loading="loading"
                            @click="handleSubmit" />
                    </div>
                </div>
            </div>
