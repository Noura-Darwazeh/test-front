        ...
        <div style="max-width: 420px; width: 100%;">
          ...
          <form @submit.prevent="onSubmit" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
              ...
              <TextField id="email" v-model="form.email" type="email" placeholder="you@example.com" :required="true" />
            ...
            <div class="mb-3">
              ...
              <TextField id="password" v-model="form.password" type="password" placeholder="••••••••" :minlength="6"
                :required="true" />
