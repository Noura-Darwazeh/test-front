...
driverPortal: 'Driver Portal',
  ...
  user: {
    ...
    form: {
      ...
      notificationEventsSection: "Notification Events",
      notifyOrderUpdates: "Order Updates",
      notifyWorkPlanUpdates: "Work Plan Updates",
    ...
    validation: {
      ...
      cannotAddAdmin: "Cannot add admin users",
    },
  ...
  customerCompanyAccounts: {
    title: "Customer Company Accounts",
    subtitle: "List of users with activity in company accounts",
  },
  ...
  driver: {
    ...
    form: {
      ...
      whatsappAlert: "WhatsApp",
      notificationEventsSection: "Notification Events",
      notifyWorkPlanCreated: "Receive notifications when a work plan is assigned to me",
      notifyDriverLineUpdate: "Receive notifications on driver line updates",
      notifyWorkPlanDelay: "Receive notifications when a work plan is delayed",
      driverTypes: {
  ...
  driverSteps: {
    ...
    tapToUpdateStatus: "Tap to update status",
    nextStep:"Next Step",
  ...
  customer: {
    ...
    pageSubtitle: "Manage customers and their details",
  ...
  company: {
    ...
    pageSubtitle: "Manage companies and their details",
    active: "Active",
    inactive: "Inactive",
    sharedLine: "Shared Line",
    ...
    validation: {
      ...
      latitudeInvalid: "Invalid latitude (must be between -90 and 90)",
      longitudeInvalid: "Invalid longitude (must be between -180 and 180)",
      imageRequired: "Company image is required",
      imageSize: "Image must not exceed 200KB",
      imageFormat: "Image must be JPEG, JPG or PNG",
  ...
  common: {
    ...
    bulkActivateSuccess: "{count} item(s) activated successfully!",
    bulkDeactivateSuccess: "{count} item(s) deactivated successfully!",
    filterByStatus: "Filter by Status",
    filterByCompany: "Filter by Company",
    filterByType: "Filter by Type",
    filterByCustomer: "Filter by Customer",
    filterBySharedLine: "Filter by Shared Line",
    ...
    activateConfirmMessage: "Are you sure you want to activate this item?",
    deactivateConfirmMessage: "Are you sure you want to deactivate this item?",
    ok: "OK",
    done: "Done",
    ...
    validation: {
      ...
      orderRowRequired: "At least one order row is required",
      branchNameRequired: "Branch name is required",
    },
  ...
  workPlan: {
    ...
    noPermissionToEdit: "You don't have permission to edit this work plan",
    noPermissionToDelete: "You don't have permission to delete this work plan",
    noPermissionForBulk: "You don't have permission to perform bulk actions on selected items",
  ...
  invoice: {
    ...
    markAsPaidConfirm: "Are you sure you want to mark {count} invoice(s) as paid?",
    markedAsPaidSuccess: "Invoice(s) marked as paid successfully!",
    markedAsPaidError: "Failed to mark invoice(s) as paid",
    selectOneInvoice: "Please select exactly one invoice",
  ...
  payment: {
    ...
    bankPaymentDesc: "Transfer payment to bank account",
    driverPayment: "Driver Payment",
    driverPaymentDesc: "Pay through a driver",
