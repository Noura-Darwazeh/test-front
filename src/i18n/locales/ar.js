export default {
  navbar: {
    ...
    totalNotifications: "إشعار",
    searchNotifications: "البحث في الإشعارات...",
    noResults: "لا توجد إشعارات مطابقة",
    ...
    confirmLogout: "هل أنت متأكد من تسجيل الخروج؟",
    logout: "تسجيل الخروج",
    returnToAdmin: "العودة",
    switchedUser: "تم تبديل المستخدم",
    switchUserFailed: "فشل في تبديل المستخدم",
  },
...
driverPortal: 'بوابة السائقين',
  ...
  forgotPassword: {
    ...
    emailPlaceholder: "example(at)example.com",
  ...
  user: {
    ...
    form: {
      ...
      selectUserPlaceholder: "اختر مستخدم من القائمة",
      notificationSection: "إعدادات الإشعارات",
      notificationPhone: "هاتف الإشعارات",
      notificationEmails: "بريد الإشعارات",
      smsAlert: "SMS",
      webAlert: "ويب",
      emailAlert: "بريد",
      mobileAlert: "جوال",
      telegramAlert: "تيليغرام",
      whatsappAlert: "واتساب",
      notificationEventsSection: "أحداث الإشعارات",
      notifyOrderUpdates: "تلقي إشعارات عند تغييرات وتحديثات الطلبات",
      notifyWorkPlanUpdates: "تلقي إشعارات عند تغييرات وتحديثات خطط العمل",
    ...
    validation: {
      ...
      cannotAddAdmin: "لا يمكن إضافة مستخدمين مسؤولين",
    },
  ...
  customerCompanyAccounts: {
    title: "حسابات شركات العملاء",
    subtitle: "قائمة المستخدمين الذين لديهم حسابات شركات نشطة",
  },
  ...
  driver: {
    ...
    deleteFailed: "فشل في حذف السائق",
    orders: "طلبات",
    workPlans: "خطط العمل",
    ...
    form: {
      ...
      whatsappAlert: "واتساب",
      notificationEventsSection: "أحداث الإشعارات",
      notifyWorkPlanCreated: "تلقي إشعارات عند إسناد خطة عمل إليّ",
      notifyDriverLineUpdate: "تلقي إشعارات عند تحديثات خط السائق",
      notifyWorkPlanDelay: "تلقي إشعارات عند تأخر خطة العمل",
    },
    ...
    validation: {
      ...
      driverRequired: "اختيار السائق مطلوب",
      invalidStatus: "قيمة حالة غير صالحة",
    },
  ...
  driverSteps: {
    ...
    tapToUpdateStatus: "اضغط لتحديث الحالة",
  ...
  branch: {
    ...
    validation: {
      ...
      latitudeInvalid: "خط عرض غير صالح (يجب أن يكون بين -90 و 90)",
      longitudeInvalid: "خط طول غير صالح (يجب أن يكون بين -180 و 180)",
    },
  ...
  orders: {
    ...
    progress: {
      ...
      selectOrderHint: "اختر طلبًا لعرض تقدم الطلب.",
  ...
  statistics: {
    ...
    tabs: {
     ...
     charts:{
      title: "الرسوم البيانية للتحليلات",
      ordersTab: "الطلبات",
      ordersTabDesc: "تحليلات المبيعات والتسليم",
      driversTab: "السائقين",
      driversTabDesc: "رؤى الأداء والنشاط",
      ordersReport: "تقرير تحليلات الطلبات",
      driversReport: "تقرير تحليلات السائقين",
      liveData: "البيانات المباشرة",
      refresh: "تحديث",
      loadingOrders: "جارٍ تحميل تحليلات الطلبات...",
      loadingDrivers: "جارٍ تحميل تحليلات السائقين...",
      noOrdersData: "لا توجد بيانات للطلبات",
      noOrdersDesc: "بيانات مخطط الطلبات غير متوفرة",
      noDriversData: "لا توجد بيانات للسائقين",
      noDriversDesc: "بيانات مخطط السائقين غير متوفرة",
  ...
  workPlan: {
    ...
    noOrderItems: "لم يتم العثور على عناصر الطلب",
    noPermissionToEdit: "ليس لديك صلاحية لتعديل خطة العمل هذه",
    noPermissionToDelete: "ليس لديك صلاحية لحذف خطة العمل هذه",
    noPermissionForBulk: "ليس لديك صلاحية لتنفيذ إجراءات جماعية على العناصر المحددة",
    selectPlan: "اختر خطة",
  ...
  common: {
    ...
    deactivateSuccess: "تم إلغاء التفعيل بنجاح!",
    bulkActivateSuccess: "تم تفعيل {count} عنصر(عناصر) بنجاح!",
    bulkDeactivateSuccess: "تم إلغاء تفعيل {count} عنصر(عناصر) بنجاح!",
    filterByStatus: "تصفية حسب الحالة",
    filterByCompany: "تصفية حسب الشركة",
    filterByType: "تصفية حسب النوع",
    filterByCustomer: "تصفية حسب العميل",
    filterBySharedLine: "تصفية حسب الخط المشترك",
    filterByCase: "تصفية حسب الحالة",
    filterByPackage: "تصفية حسب الطرد",
    ...
    activateConfirmMessage: "هل أنت متأكد من تفعيل هذا العنصر؟",
    deactivateConfirmMessage: "هل أنت متأكد من إلغاء تفعيل هذا العنصر؟",
    validation: {
      ...
      phoneTooShort: "رقم الهاتف قصير جداً (الحد الأدنى 10 أرقام)",
      phoneTooLong: "رقم الهاتف طويل جداً (الحد الأقصى 15 رقماً)"
    },
  ...
  payment: {
    ...
    selectedPayments: "تم تحديد {count} مدفوعات",
    bankPayment: "دفع بنكي",
    bankPaymentDesc: "تحويل الدفعة إلى حساب بنكي",
    driverPayment: "دفع عبر السائق",
    driverPaymentDesc: "الدفع من خلال سائق",
    selectDriver: "اختر سائق",
    selectDriverPlaceholder: "اختر سائقاً...",
    driverRequired: "السائق مطلوب",
    selectPaymentMethodError: "يرجى اختيار طريقة دفع",
    form: {
      amount: "المبلغ",
  ...
  invoice: {
    ...
    markAsPaid: "مدفوع",
    to: "الى",
    selectInvoices: "يرجى تحديد فاتورة واحدة على الأقل",
    markAsPaidConfirm: "هل أنت متأكد من تحديد {count} فاتورة كمدفوعة؟",
    markedAsPaidSuccess: "تم تحديد الفاتورة (الفواتير) كمدفوعة بنجاح!",
    markedAsPaidError: "فشل في تحديد الفاتورة (الفواتير) كمدفوعة",
    selectOneInvoice: "يرجى تحديد فاتورة واحدة فقط",
    exportError: "فشل في تصدير ملف PDF",
  },
  ...
  events: {
    ...
    addSuccess: "تم إنشاء الحدث بنجاح.",
    updateSuccess: "تم تحديث الحدث بنجاح.",
